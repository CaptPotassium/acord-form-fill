...
| A5 | ~70% of fields derivable from available documents | **Measured:** 74.5% of applicable fields resolved, 43.0% of mapped fields written | **Resolved into a reporting decision, not a risk** — the tool reports both rates and asks the customer which one the pilot is measured on |
